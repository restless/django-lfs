...
class PropertiesTestCase(TestCase):
    ...
    def test_set_filter_2(self):
        ...
        self.client.post(url, {"category_id": self.c1.pk, "property_id": 1, "min": "10", "max": "20"})
...
class ViewsTestCase(TestCase):
    ...
    def test_set_filter(self):
        ...
        request = RequestFactory().post("/", {"product_id": "1", "min": 0, "max": 999, "property_id": 1, "category_id": category.pk})
        request.session = SessionStore()

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreferredLanguage'
        db.create_table('customer_preferredlanguage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='preferred_language', unique=True, to=orm['auth.User'])),
            ('language', self.gf('django.db.models.fields.CharField')(default='pl', max_length=5)),
        ))
        db.send_create_signal('customer', ['PreferredLanguage'])


    def backwards(self, orm):
        # Deleting model 'PreferredLanguage'
        db.delete_table('customer_preferredlanguage')
    ...
    models = {
        ...
        'customer.preferredlanguage': {
            'Meta': {'object_name': 'PreferredLanguage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'pl'", 'max_length': '5'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'preferred_language'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'payment.paymentmethod': {
            ...
            'name_pl': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'note_pl': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
